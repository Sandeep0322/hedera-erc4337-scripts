const { Client, PrivateKey, AccountCreateTransaction, AccountBalanceQuery, Hbar, TransferTransaction} = require("@hashgraph/sdk");
 ...
 const createWalletFromCredits = async (accountId, publicKey, privateKey) => {
    if (this.uKey) {            
  ...
  const checkAccountDetails = async (_accountId, _publicKey, _privateKey) => {
