...
exports.wrapSimpleProvider = exports.wrapProvider = void 0;
...
async function wrapSimpleProvider(originalProvider, config, originalSigner = originalProvider.getSigner()) {
    const entryPoint = contracts_1.EntryPoint__factory.connect(config.entryPointAddress, originalProvider);
    const smartAccountAPI = new SimpleAccountAPI_1.SimpleAccountAPI({
        provider: originalProvider,
        entryPointAddress: entryPoint.address,
...
exports.wrapSimpleProvider = wrapSimpleProvider;
